 ...
 * navigates away. The flyer is a standalone static page under public/, so
 * that's a real navigation rather than a scroll. Wick is deliberately left
 * out of nav — its page still exists under public/ and is reachable by
 * direct URL, but it's locked out of home-page discovery, same as its card
